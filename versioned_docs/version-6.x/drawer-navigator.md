...
The Drawer Navigator supports both Reanimated 1 and Reanimated 2. If you want to use Reanimated 2, make sure to configure it following this [guide](https://docs.swmansion.com/react-native-reanimated/docs).
