...
This guide covers [createBottomTabNavigator](/docs/bottom-tab-navigator.html). You may also use [createMaterialBottomTabNavigator](/docs/material-bottom-tab-navigator.html) and [createMaterialTopTabNavigator](/docs/material-top-tab-navigator.html) to add tabs to your application.
...
* Read the [full API reference](/docs/bottom-tab-navigator.html) for further information on `TabNavigator` configuration options.
