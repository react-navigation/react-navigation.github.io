...
- `this.props.navigation.navigate('RouteName')` pushes a new route to the stack navigator. We can call it as many times as we like and it will continue pushing routes.
