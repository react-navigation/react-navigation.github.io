...
- `props` - The same props that are available to the screen component
  - `navigation` - The [navigation prop](/docs/navigation-prop.html) for the screen, with the screen's route at `navigation.state`
...
- [`drawer navigator`](/docs/drawer-navigator.html#screen-navigation-options)
- [`stack navigator`](/docs/stack-navigator.html#navigationoptions-used-by-stacknavigator)
- [`tab navigator`](/docs/tab-navigator.html#navigationoptions-used-by-tabnavigator)
