...
Native Stack is available in the new 5.0 alpha API and with [Satyajit](undefined)’s help, I have managed to release the first version of the [library](https://www.npmjs.com/package/@react-navigation/native-stack) a few days ago. It’s in alpha so don’t expect everything to be perfect, but… don’t hesitate to submit a [PR](https://github.com/react-navigation/navigation-ex/pulls) and help us grow React Navigation!
