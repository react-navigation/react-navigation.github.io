...
class Help extends React.Component {
  render() {
    const supportLinks = [
      {
        content:
          <translate>Learn more using the [documentation on this site](https://reactnavigation.org/docs/en/getting-started.html) and [reading the API reference](/content/docs/api-reference.html).</translate>,
