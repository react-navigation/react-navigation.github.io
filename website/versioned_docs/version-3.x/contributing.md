...
The [NavigationPlayground](https://github.com/react-navigation/react-navigation-4/tree/3.0/examples/NavigationPlayground) example app includes a variety of patterns and is used as a simple way for contributors to manually integration test changes. See the [README](https://github.com/react-navigation/react-navigation-4/blob/3.0/examples/NavigationPlayground/README.md) for instructions to run it.
