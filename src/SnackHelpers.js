...
const DEPS_VERSIONS = {
  ...
  '7': [
    ...
    'react-native-screens@*',
    'react-native-tab-view@^3.0.0',
    '@react-navigation/bottom-tabs@7.0.0-alpha.0',
    '@react-navigation/drawer@7.0.0-alpha.0',
    '@react-navigation/elements@1.3.16',
    '@react-navigation/material-bottom-tabs@7.0.0-alpha.0',
    '@react-navigation/material-top-tabs@7.0.0-alpha.0',
    '@react-navigation/native-stack@7.0.0-alpha.0',
    '@react-navigation/native@7.0.0-alpha.0',
    '@react-navigation/stack@7.0.0-alpha.0',
  ],
  next: [],
};
